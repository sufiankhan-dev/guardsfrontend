...
export const stateOptions = countryData
  .flatMap((country) => country.states) // Extract states array from each country
  .map((state) => ({
    value: state.name, // Both the label and value are the state's name
    label: state.name,
  }));
