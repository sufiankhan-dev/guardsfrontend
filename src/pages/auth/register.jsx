...
import { Link } from "react-router-dom";
import useDarkMode from "@/hooks/useDarkMode";
import RegForm from "./common/reg-from"; // Ensure path and filename match exactly
import Social from "./common/social";
import { ToastContainer } from "react-toastify";
// Image imports
import LogoWhite from "@/assets/images/logo/logo-white.svg";
        ...
        <div className="right-column relative bg-white dark:bg-slate-800">
          <div className="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
            <div className="auth-box h-full flex flex-col justify-center">
              ...
              {/* Sign In Link */}
              <div className="max-w-[220px] mx-auto font-normal text-slate-500 dark:text-slate-400 2xl:mt-12 mt-6 uppercase text-sm">
                Already registered?{" "}
                <Link
                  to="/"
                  className="text-slate-900 dark:text-white font-medium hover:underline"
